...
<Info>Screens verified by `walkthroughs/test_recipes.py`.</Info>
...
```text
hello       demo box for the recipes walkthrough  default          project
scratch     copy the cwd into a directory node, no box             bundled
scratchbox  shell in a clean box over a throwaway copy of the cwd  bundled
sh          shell in a clean box over your current directory       bundled
wt          cut a worktree, no box                                 bundled
wtbox       shell in a clean box over a fresh git worktree         bundled
```
